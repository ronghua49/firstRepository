			...
			<div class="box-solid">
				<div class="box-body">
					...
					<form  class="form-horizontal" 
						id="loginForm">
						<div class="box-body">
							<div class="alert alert-error" id="error" hidden>
								...
								<div class="form-group">
									...
									<div class="col-sm-11">
										<input type="text" class="form-control" id="adminName"
											name="adminName"  value="${adminName}" placeholder="登录帐号">
									</div>
								</div>
								<div class="form-group">
									<label class="col-sm-1 control-label"><i
					...
					<div>
						<button type="button" id="loginBtn"
							class="btn btn-info  btn-lg btn-block">进入管理系统</button>
					</div>
				</div>
			</div>
		</section>
					...
					success:function(res){
						if(res.state == "success") {
							...
							window.location.href=callback;
								...
								window.location.href="/film/filmList";
							}
							//当登录成功后，跳转
						} else {
